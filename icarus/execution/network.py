...
class NetworkController(object):
    ...
    def queue_push(self, event):
        return heappush(self.model.queue_event, event)

    def queue_pop(self):
        return heappop(self.model.queue_event)
    ...
    def start_session(self, timestamp, receiver, content, session_id, log):
